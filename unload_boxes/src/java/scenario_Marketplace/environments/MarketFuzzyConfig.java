...
public class MarketFuzzyConfig 
{
	...
	private static void setNumOwnImpressions(int numberSellers, int numberBuyers)
	{
		min_own_imps = 0;
		max_own_imps = (numberSellers * numberBuyers) / 3;
	}
	
	private static void setNumOtherImpressions(int numberSellers, int numberBuyers)
	{
		min_other_imps = 0;
		max_other_imps = numberSellers * numberBuyers;
	}
	
	public static void createFuzzyFile(int numberSellers, int numberBuyers)
	{
		setUrgency();
		setSelfConfident();
		setNumOwnImpressions(numberSellers, numberBuyers);
		setNumOtherImpressions(numberSellers, numberBuyers);
